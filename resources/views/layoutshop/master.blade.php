...
<link rel="stylesheet" href="{{ asset('assets/shop/css/blue.css') }}">
<link rel="stylesheet" href="{{ asset('assets/shop/css/owl.carousel.css') }}">
<link rel="stylesheet" href="{{ asset('assets/shop/css/owl.transitions.css') }}">
<link rel="stylesheet" href="{{ asset('assets/shop/css/animate.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/shop/css/rateit.css') }}">
<link rel="stylesheet" href="{{ asset('assets/shop/css/bootstrap-select.min.css') }}">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="home.html"> <img src="{{ asset('assets/shop/images/logo.png') }}" alt="logo"> </a> </div>
          <!-- /.logo -->
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 animate-dropdown top-cart-row">
          ...
          <div class="dropdown dropdown-cart">
            ...
            <div class="items-cart-inner">
              ...
              {{-- <div class="total-price-basket">  <span class="lbl">Pannier </span><span class="value"></span> </div> --}}
              </div>
            </div>
            </a>
            {{-- <ul class="dropdown-menu">
...
<script src="{{asset('assets/shop/js/jquery-1.11.1.min.js') }}"></script>
<script src="{{asset('assets/shop/js/bootstrap.min.js') }}"></script>
<script src="{{asset('assets/shop/js/bootstrap-hover-dropdown.min.js') }}"></script>
<script src="{{asset('assets/shop/js/owl.carousel.min.js') }}"></script>
<script src="{{asset('assets/shop/js/echo.min.js') }}"></script>
<script src="{{asset('assets/shop/js/jquery.easing-1.3.min.js') }}"></script>
<script src="{{asset('assets/shop/js/bootstrap-slider.min.js') }}"></script>
<script src="{{asset('assets/shop/js/jquery.rateit.min.js') }}"></script>
<script src="{{asset('assets/shop/js/lightbox.min.js') }}"></script>
<script src="{{asset('assets/shop/js/bootstrap-select.min.js') }}"></script>
