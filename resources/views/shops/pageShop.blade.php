      ...
      <div class='row'>
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 rht-col">
          ...
          <div id="category" class="category-carousel hidden-xs">
            <div class="item">
              <div class="image"> <img src="{{asset('assets/shop/images/banners/cat-banner-1.jpg') }}" alt="" class="img-responsive"> </div>
              ...
              <div class="col col-sm-6 col-md-3 col-lg-3 col-xs-6">
                <div class="filter-tabs">
                  <ul id="filter-tabs" class="nav nav-tabs nav-tab-box nav-tab-fa-icon">
                    <li class="active"> <a data-toggle="tab" href="#grid-container"><i class="icon fa fa-th-large"></i>Produits Populaires</a> </li>
                                                  ...
                                                  <div class="product-image">
                                                          <div class="image">
                                                              <a href="{{route('shops.detailShop',$produit->id)}}">
                                                                  ...
                                                                  <img src="{{asset('/storage/produits/'.$produit->image)}}" alt="">
                                                                  {{-- <img src="{{asset('/storage/produits/'.$produit->image)}}" alt="" class="hover-image"> --}}

                                                              </a>
                                                          </div>
                                                  </div>
                                                  <div class="product-info text-left">
                                                      <h3 class="name"><a href="{{route('shops.detailShop', $produit->id)}}">{{$produit->nom_prod}}</a></h3>
                                                      <div class="rating rateit-small"></div>
                                                      <div class="description"></div>
                                                      <div class="product-price"> <span class="price"> {{$produit->prix}} Fcfa</span></div>
                                                  </div>
                                                      ...
                                                      <ul class="list-unstyled">
                                                          <li class="add-cart-button btn-group">
                                                            <form action="{{route('cart.store')}}" method="post">
                                                              ...
                                                              <button class="btn btn-primary cart-btn" type="button">Ajouter</button> --}}
                                                          </li>
                                                          <li class="lnk wishlist"> <a class="add-to-cart" href="{{route('shops.detailShop', $produit->id)}}" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                                                      </ul>
                                                  </div>
                                              </div>
                                          </div>
